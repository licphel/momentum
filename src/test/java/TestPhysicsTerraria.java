...
public class TestPhysicsTerraria {
  ...
  private static void testSlopeUpNoBounce() {
    ...
    for (int x = 5; x <= 7; x++) setBlock(level, x, 1, slopeRight());
  ...
  private static BlockState slopeRight() { return Registries.SLOPE_RIGHT.defaultState(); }
  private static BlockState slopeLeft() { return Registries.SLOPE_LEFT.defaultState(); }

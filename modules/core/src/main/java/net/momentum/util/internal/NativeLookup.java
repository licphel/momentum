package net.momentum.util.internal;

import net.momentum.util.Platform;
 ...
 *
 * <p>Backend modules ({@code momentum-opengl}, {@code momentum-openal}, {@code momentum-glfw})
    ...
    if (found == null) {
      throw new IllegalArgumentException(
          "Class " + type.getName() + " has no lookup. " +
              "Ensure the backend module (momentum-opengl/momentum-openal/momentum-glfw) is on the classpath.");
    }
